        ...
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl border border-slate-200 shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
          ...
          <div className="p-2 space-y-1">
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-1.5 text-[11px] font-medium text-slate-600 hover:bg-slate-100 rounded-xl transition cursor-pointer"
              title="Limpa a memória do app e baixa a versão mais recente"
            >
              <RefreshCw className="w-3.5 h-3.5 text-slate-400" />
              <span>Atualizar Versão do App</span>
            </button>
